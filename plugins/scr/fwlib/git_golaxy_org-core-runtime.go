...
func init() {
	Symbols["git.golaxy.org/core/runtime/runtime"] = map[string]reflect.Value{
		...
		"BindEventEntityMgrEntityFirstTouchComponent":   reflect.ValueOf(runtime.BindEventEntityMgrEntityFirstTouchComponent),
		...
		"EventEntityMgrAddEntityId":                     reflect.ValueOf(&runtime.EventEntityMgrAddEntityId).Elem(),
		"EventEntityMgrEntityAddComponentsId":           reflect.ValueOf(&runtime.EventEntityMgrEntityAddComponentsId).Elem(),
		"EventEntityMgrEntityFirstTouchComponentId":     reflect.ValueOf(&runtime.EventEntityMgrEntityFirstTouchComponentId).Elem(),
		"EventEntityMgrEntityRemoveComponentId":         reflect.ValueOf(&runtime.EventEntityMgrEntityRemoveComponentId).Elem(),
		"EventEntityMgrRemoveEntityId":                  reflect.ValueOf(&runtime.EventEntityMgrRemoveEntityId).Elem(),
		...
		"HandleEventEntityMgrEntityFirstTouchComponent": reflect.ValueOf(runtime.HandleEventEntityMgrEntityFirstTouchComponent),
		...
		"EventEntityMgrEntityFirstTouchComponent":        reflect.ValueOf((*runtime.EventEntityMgrEntityFirstTouchComponent)(nil)),
		"EventEntityMgrEntityFirstTouchComponentHandler": reflect.ValueOf((*runtime.EventEntityMgrEntityFirstTouchComponentHandler)(nil)),
		...
		"IEntityMgrEventTab":                             reflect.ValueOf((*runtime.IEntityMgrEventTab)(nil)),
		...
		"_EventEntityMgrEntityFirstTouchComponent": reflect.ValueOf((*_git_golaxy_org_core_runtime_EventEntityMgrEntityFirstTouchComponent)(nil)),
		...
		"_IEntityMgrEventTab":                      reflect.ValueOf((*_git_golaxy_org_core_runtime_IEntityMgrEventTab)(nil)),
...
func (W _git_golaxy_org_core_runtime_ConcurrentContext) CallDelegate(fun generic.DelegateFuncVar0[any, async.Ret], args ...any) async.AsyncRet {
...
func (W _git_golaxy_org_core_runtime_ConcurrentContext) CallVoidDelegate(fun generic.DelegateActionVar0[any], args ...any) async.AsyncRet {
...
func (W _git_golaxy_org_core_runtime_Context) CallDelegate(fun generic.DelegateFuncVar0[any, async.Ret], args ...any) async.AsyncRet {
	return W.WCallDelegate(fun, args...)
}
func (W _git_golaxy_org_core_runtime_Context) CallVoid(fun generic.ActionVar0[any], args ...any) async.AsyncRet {
	return W.WCallVoid(fun, args...)
}
func (W _git_golaxy_org_core_runtime_Context) CallVoidDelegate(fun generic.DelegateActionVar0[any], args ...any) async.AsyncRet {
	return W.WCallVoidDelegate(fun, args...)
}
...
func (W _git_golaxy_org_core_runtime_Context) GetPluginBundle() extension.PluginBundle {
...
type _git_golaxy_org_core_runtime_EntityMgr struct {
	...
	WEventEntityMgrEntityFirstTouchComponent func() event.IEvent
...
func (W _git_golaxy_org_core_runtime_EntityMgr) CountEntities() int { return W.WCountEntities() }
...
func (W _git_golaxy_org_core_runtime_EntityMgr) EventEntityMgrEntityFirstTouchComponent() event.IEvent {
	return W.WEventEntityMgrEntityFirstTouchComponent()
}
...
func (W _git_golaxy_org_core_runtime_EntityMgr) GetEntities() []ec.Entity { return W.WGetEntities() }
...
func (W _git_golaxy_org_core_runtime_EntityMgr) RemoveEntity(id uid.Id) { W.WRemoveEntity(id) }
...
// _git_golaxy_org_core_runtime_EventEntityMgrEntityFirstTouchComponent is an interface wrapper for EventEntityMgrEntityFirstTouchComponent type
type _git_golaxy_org_core_runtime_EventEntityMgrEntityFirstTouchComponent struct {
	IValue                                interface{}
	WOnEntityMgrEntityFirstTouchComponent func(entityMgr runtime.EntityMgr, entity ec.Entity, component ec.Component)
}

func (W _git_golaxy_org_core_runtime_EventEntityMgrEntityFirstTouchComponent) OnEntityMgrEntityFirstTouchComponent(entityMgr runtime.EntityMgr, entity ec.Entity, component ec.Component) {
	W.WOnEntityMgrEntityFirstTouchComponent(entityMgr, entity, component)
}
...
// _git_golaxy_org_core_runtime_IEntityMgrEventTab is an interface wrapper for IEntityMgrEventTab type
type _git_golaxy_org_core_runtime_IEntityMgrEventTab struct {
	IValue                                   interface{}
	WEventEntityMgrAddEntity                 func() event.IEvent
	WEventEntityMgrEntityAddComponents       func() event.IEvent
	WEventEntityMgrEntityFirstTouchComponent func() event.IEvent
...
func (W _git_golaxy_org_core_runtime_IEntityMgrEventTab) EventEntityMgrAddEntity() event.IEvent {
	return W.WEventEntityMgrAddEntity()
}
func (W _git_golaxy_org_core_runtime_IEntityMgrEventTab) EventEntityMgrEntityAddComponents() event.IEvent {
	return W.WEventEntityMgrEntityAddComponents()
}
func (W _git_golaxy_org_core_runtime_IEntityMgrEventTab) EventEntityMgrEntityFirstTouchComponent() event.IEvent {
	return W.WEventEntityMgrEntityFirstTouchComponent()
}
func (W _git_golaxy_org_core_runtime_IEntityMgrEventTab) EventEntityMgrEntityRemoveComponent() event.IEvent {
	return W.WEventEntityMgrEntityRemoveComponent()
}
func (W _git_golaxy_org_core_runtime_IEntityMgrEventTab) EventEntityMgrRemoveEntity() event.IEvent {
	return W.WEventEntityMgrRemoveEntity()
}
