// Code generated by 'yaegi extract git.golaxy.org/scaffold/plugins/view'. DO NOT EDIT.

package fwlib

import (
	"git.golaxy.org/core/utils/generic"
	"git.golaxy.org/scaffold/plugins/view"
	"reflect"
)

func init() {
	Symbols["git.golaxy.org/scaffold/plugins/view/view"] = map[string]reflect.Value{
		...
		"_IProp":     reflect.ValueOf((*_git_golaxy_org_scaffold_plugins_view_IProp)(nil)),
		"_IPropSync": reflect.ValueOf((*_git_golaxy_org_scaffold_plugins_view_IPropSync)(nil)),
		"_IPropTab":  reflect.ValueOf((*_git_golaxy_org_scaffold_plugins_view_IPropTab)(nil)),
		"_IPropView": reflect.ValueOf((*_git_golaxy_org_scaffold_plugins_view_IPropView)(nil)),
	}
}

// _git_golaxy_org_scaffold_plugins_view_IProp is an interface wrapper for IProp type
type _git_golaxy_org_scaffold_plugins_view_IProp struct {
	IValue     interface{}
...
// _git_golaxy_org_scaffold_plugins_view_IPropSync is an interface wrapper for IPropSync type
type _git_golaxy_org_scaffold_plugins_view_IPropSync struct {
	IValue     interface{}
	WAtti      func() any
...
func (W _git_golaxy_org_scaffold_plugins_view_IPropSync) Unmarshal(data []byte, revision int64) error {
	return W.WUnmarshal(data, revision)
}

// _git_golaxy_org_scaffold_plugins_view_IPropTab is an interface wrapper for IPropTab type
type _git_golaxy_org_scaffold_plugins_view_IPropTab struct {
	IValue      interface{}
...
func (W _git_golaxy_org_scaffold_plugins_view_IPropTab) AddProp(name string, ps view.IPropSync) {
	W.WAddProp(name, ps)
}
func (W _git_golaxy_org_scaffold_plugins_view_IPropTab) EachProps(fun generic.Action2[string, view.IPropSync]) {
	W.WEachProps(fun)
}
func (W _git_golaxy_org_scaffold_plugins_view_IPropTab) GetProp(name string) view.IPropSync {
	return W.WGetProp(name)
}
func (W _git_golaxy_org_scaffold_plugins_view_IPropTab) RangeProps(fun generic.Func2[string, view.IPropSync, bool]) {
	W.WRangeProps(fun)
}

// _git_golaxy_org_scaffold_plugins_view_IPropView is an interface wrapper for IPropView type
type _git_golaxy_org_scaffold_plugins_view_IPropView struct {
	IValue interface{}
}
