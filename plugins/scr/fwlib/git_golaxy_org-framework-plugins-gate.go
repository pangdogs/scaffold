...
func (W _git_golaxy_org_framework_plugins_gate_IGate) CountSessions() int { return W.WCountSessions() }
...
func (W _git_golaxy_org_framework_plugins_gate_IGate) Watch(ctx context.Context, handler gate.SessionStateChangedHandler) gate.IWatcher {
...
func (W _git_golaxy_org_framework_plugins_gate_ISession) Closed() <-chan struct{} { return W.WClosed() }
func (W _git_golaxy_org_framework_plugins_gate_ISession) Deadline() (deadline time.Time, ok bool) {
	return W.WDeadline()
}
func (W _git_golaxy_org_framework_plugins_gate_ISession) Done() <-chan struct{} { return W.WDone() }
func (W _git_golaxy_org_framework_plugins_gate_ISession) Err() error            { return W.WErr() }
func (W _git_golaxy_org_framework_plugins_gate_ISession) GetContext() service.Context {
	return W.WGetContext()
}
func (W _git_golaxy_org_framework_plugins_gate_ISession) GetId() uid.Id { return W.WGetId() }
...
func (W _git_golaxy_org_framework_plugins_gate_ISession) GetToken() string  { return W.WGetToken() }
func (W _git_golaxy_org_framework_plugins_gate_ISession) GetUserId() string { return W.WGetUserId() }
func (W _git_golaxy_org_framework_plugins_gate_ISession) RecvDataChan() <-chan binaryutil.RecycleBytes {
	return W.WRecvDataChan()
}
func (W _git_golaxy_org_framework_plugins_gate_ISession) RecvEventChan() <-chan transport.IEvent {
...
func (W _git_golaxy_org_framework_plugins_gate_ISession) SendEvent(event transport.IEvent) error {
	return W.WSendEvent(event)
}
func (W _git_golaxy_org_framework_plugins_gate_ISession) SendEventChan() chan<- transport.IEvent {
...
func (W _git_golaxy_org_framework_plugins_gate_ISession) Value(key any) any { return W.WValue(key) }
func (W _git_golaxy_org_framework_plugins_gate_ISession) WatchData(ctx context.Context, handler gate.SessionRecvDataHandler) gate.IWatcher {
	return W.WWatchData(ctx, handler)
}
func (W _git_golaxy_org_framework_plugins_gate_ISession) WatchEvent(ctx context.Context, handler gate.SessionRecvEventHandler) gate.IWatcher {
...
func (W _git_golaxy_org_framework_plugins_gate_IWatcher) Done() <-chan struct{} { return W.WDone() }
func (W _git_golaxy_org_framework_plugins_gate_IWatcher) Err() error            { return W.WErr() }
...
func (W _git_golaxy_org_framework_plugins_gate_IWatcher) Value(key any) any { return W.WValue(key) }
