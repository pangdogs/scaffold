...
// _git_golaxy_org_framework_plugins_rpc_rpcpcsr_ICallee is an interface wrapper for ICallee type
type _git_golaxy_org_framework_plugins_rpc_rpcpcsr_ICallee struct {
	IValue  interface{}
	WCallee func(method string) reflect.Value
}

func (W _git_golaxy_org_framework_plugins_rpc_rpcpcsr_ICallee) Callee(method string) reflect.Value {
