...
func init() {
	Symbols["git.golaxy.org/core/service/service"] = map[string]reflect.Value{
		...
		"RunningState_AddInActivated":    reflect.ValueOf(service.RunningState_AddInActivated),
		"RunningState_AddInActivating":   reflect.ValueOf(service.RunningState_AddInActivating),
		"RunningState_AddInDeactivated":  reflect.ValueOf(service.RunningState_AddInDeactivated),
		"RunningState_AddInDeactivating": reflect.ValueOf(service.RunningState_AddInDeactivating),
