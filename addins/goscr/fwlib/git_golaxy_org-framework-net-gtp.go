...
func init() {
	Symbols["git.golaxy.org/framework/net/gtp/gtp"] = map[string]reflect.Value{
		...
		"AsymmetricEncryption_ECDSA":             reflect.ValueOf(gtp.AsymmetricEncryption_ECDSA),
		"AsymmetricEncryption_None":              reflect.ValueOf(gtp.AsymmetricEncryption_None),
		"AsymmetricEncryption_RSA":               reflect.ValueOf(gtp.AsymmetricEncryption_RSA),
		...
		"Flag_Signed":                            reflect.ValueOf(gtp.Flag_Signed),
		"Flag_VerifyEncryption":                  reflect.ValueOf(gtp.Flag_VerifyEncryption),
		"Flags_None":                             reflect.ValueOf(gtp.Flags_None),
		"Hash_BLAKE2b256":                        reflect.ValueOf(gtp.Hash_BLAKE2b256),
		"Hash_BLAKE2b384":                        reflect.ValueOf(gtp.Hash_BLAKE2b384),
		"Hash_BLAKE2b512":                        reflect.ValueOf(gtp.Hash_BLAKE2b512),
		"Hash_BLAKE2s256":                        reflect.ValueOf(gtp.Hash_BLAKE2s256),
		"Hash_None":                              reflect.ValueOf(gtp.Hash_None),
		"Hash_SHA256":                            reflect.ValueOf(gtp.Hash_SHA256),
		"Hash_SHA384":                            reflect.ValueOf(gtp.Hash_SHA384),
		...
		"NamedCurve_P521":                        reflect.ValueOf(gtp.NamedCurve_P521),
		...
		"MsgSigned":                 reflect.ValueOf((*gtp.MsgSigned)(nil)),
