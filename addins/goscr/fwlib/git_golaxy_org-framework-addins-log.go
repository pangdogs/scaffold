...
func (W _git_golaxy_org_framework_addins_log_ILogger) Log(level log.Level, v ...interface{}) {
	W.WLog(level, v...)
}
func (W _git_golaxy_org_framework_addins_log_ILogger) Logf(level log.Level, format string, v ...interface{}) {
	W.WLogf(level, format, v...)
}
func (W _git_golaxy_org_framework_addins_log_ILogger) Logln(level log.Level, v ...interface{}) {
	W.WLogln(level, v...)
}
