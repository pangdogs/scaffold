...
func (W _git_golaxy_org_framework_addins_gate_IGate) EachSessions(fun generic.Action1[gate.ISession]) {
	W.WEachSessions(fun)
}
func (W _git_golaxy_org_framework_addins_gate_IGate) GetSession(sessionId uid.Id) (gate.ISession, bool) {
...
func (W _git_golaxy_org_framework_addins_gate_ISession) GetState() gate.SessionState {
	return W.WGetState()
}
func (W _git_golaxy_org_framework_addins_gate_ISession) GetToken() string  { return W.WGetToken() }
func (W _git_golaxy_org_framework_addins_gate_ISession) GetUserId() string { return W.WGetUserId() }
func (W _git_golaxy_org_framework_addins_gate_ISession) RecvDataChan() <-chan binaryutil.RecycleBytes {
	return W.WRecvDataChan()
}
func (W _git_golaxy_org_framework_addins_gate_ISession) RecvEventChan() <-chan transport.IEvent {
	return W.WRecvEventChan()
}
func (W _git_golaxy_org_framework_addins_gate_ISession) SendData(data []byte) error {
	return W.WSendData(data)
}
func (W _git_golaxy_org_framework_addins_gate_ISession) SendDataChan() chan<- binaryutil.RecycleBytes {
	return W.WSendDataChan()
}
func (W _git_golaxy_org_framework_addins_gate_ISession) SendEvent(event transport.IEvent) error {
	return W.WSendEvent(event)
}
func (W _git_golaxy_org_framework_addins_gate_ISession) SendEventChan() chan<- transport.IEvent {
