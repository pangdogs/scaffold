...
//go:generate yaegi extract git.golaxy.org/core/utils/assertion
//go:generate yaegi extract git.golaxy.org/core/utils/async
//go:generate yaegi extract git.golaxy.org/core/utils/corectx
...
//go:generate yaegi extract git.golaxy.org/framework/addins/dent
//go:generate yaegi extract git.golaxy.org/framework/addins/discovery
//go:generate yaegi extract git.golaxy.org/framework/addins/discovery/discovery_etcd
...
//go:generate yaegi extract git.golaxy.org/framework/addins/dsync/dsync_etcd
//go:generate yaegi extract git.golaxy.org/framework/addins/dsync/dsync_redis
...
//go:generate yaegi extract git.golaxy.org/scaffold/addins/propview
