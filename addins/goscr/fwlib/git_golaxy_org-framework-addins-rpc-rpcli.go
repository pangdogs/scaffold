...
func init() {
	Symbols["git.golaxy.org/framework/addins/rpc/rpcli/rpcli"] = map[string]reflect.Value{
		...
		"_IProcedure": reflect.ValueOf((*_git_golaxy_org_framework_addins_rpc_rpcli_IProcedure)(nil)),
	}
}

// _git_golaxy_org_framework_addins_rpc_rpcli_IProcedure is an interface wrapper for IProcedure type
type _git_golaxy_org_framework_addins_rpc_rpcli_IProcedure struct {
	IValue        interface{}
...
func (W _git_golaxy_org_framework_addins_rpc_rpcli_IProcedure) GetCli() *rpcli.RPCli {
	return W.WGetCli()
}
func (W _git_golaxy_org_framework_addins_rpc_rpcli_IProcedure) GetName() string { return W.WGetName() }
func (W _git_golaxy_org_framework_addins_rpc_rpcli_IProcedure) GetReflected() reflect.Value {
