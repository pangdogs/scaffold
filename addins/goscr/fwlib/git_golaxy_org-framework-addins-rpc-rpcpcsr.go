...
type _git_golaxy_org_framework_addins_rpc_rpcpcsr_IDeliverer struct {
	...
	WRequest func(svcCtx service.Context, dst string, cc rpcstack.CallChain, cp callpath.CallPath, args []any) async.Future
}
...
func (W _git_golaxy_org_framework_addins_rpc_rpcpcsr_IDeliverer) Request(svcCtx service.Context, dst string, cc rpcstack.CallChain, cp callpath.CallPath, args []any) async.Future {
