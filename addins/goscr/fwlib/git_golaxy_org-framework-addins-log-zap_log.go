// Code generated by 'yaegi extract git.golaxy.org/framework/addins/log/zap_log'. DO NOT EDIT.
...
func init() {
	Symbols["git.golaxy.org/framework/addins/log/zap_log/zap_log"] = map[string]reflect.Value{
